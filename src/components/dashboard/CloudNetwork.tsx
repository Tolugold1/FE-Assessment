...
export function CloudNetwork() {
  return (
    <Card className="overflow-hidden">
      ...
      <div className="p-5 grid grid-cols-1 lg:grid-cols-[minmax(0,1.5fr)_minmax(260px,1fr)_minmax(240px,1fr)] gap-4">
        <DraggableCards
        ...
        <div className="rounded-xl border border-amber-200 bg-amber-50/70 p-4 flex flex-col">
          ...
          <button className="self-start mt-auto pt-4 inline-flex items-center gap-1.5 text-sm">
            <span className="inline-flex items-center gap-1.5 rounded-md bg-brand-500 text-white font-medium px-3 py-1.5 hover:bg-brand-600 transition-colors">
